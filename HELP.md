...
* The following dependencies are not known to work with Spring Native: 'Spring Session, Spring Boot DevTools'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 TallerTableroInteractivo:0.0.1-SNAPSHOT
```
...
```
$ target/TallerTableroInteractivo
```
